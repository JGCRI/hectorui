              ...
              p(selectInput
                ("capabilities", "Choose capability identifiers:",
                  list('Carbon Cycle' = list("Atmospheric CO2"="cc_co2", "Atmospheric Carbon Pool"="cc_acp"),
                       ...
                       'Halocarbon Forcings' = list("CF4 Forcing"='hf_cf4', "C2F6 Forcing"='hf_c2f6', "HFC-23 Forcing"='hf_hfc23', "HFC-32 Forcing"='hf_hfc32f', "HFC-4310 Forcing"='hf_hfc4310', "HFC-125 Forcing"='hf_hfc125', "HFC-134a Forcing"='hf_134a', "HFC-143a Forcing"='hf_hfc143a', "HFC-227ea Forcing"='hf_227ea',
                       ...
                       'Methane' = list("Atmospheric CH4"='m_a_ch4', "Preindustrial Atmospheric CH4"='m_pa_ch4', "Emissions CH4"='m_e_ch4', "Natural CH4 Emissions"='m_n_ch4', "Methane Loss - Soil"='m_soil_loss', "Methane Loss - Straosphere"='m_strat_loss'),
                       ...
                       'SO2' = list("Natural SO2"='so2_n', "Year 2000 SO2"='so2_y2k', "Anthropogenic SO2"='so2_a', "Natural CH4 Emissions"='so2_n_ch4', "Volcanic SO2"='so2_v'),
